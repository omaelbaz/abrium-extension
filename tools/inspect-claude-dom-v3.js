/**
 * claude.ai DOM inspector v3 — paste into the DevTools console ON a claude.ai
...
(() => {
  ...
  say('=============== ABRIUM DOM REPORT v3 (MARKDOWN/DOCS) ===============');
  ...
  globalThis.__abriumWatchCopy = () => {
    ...
    const analyse = (text, via) => {
      said('=============== ABRIUM COPY OBSERVATION v3 ===============');
    ...
    console.log('Abrium v3: watching the clipboard. Now click claude.ai\'s Copy button on the Markdown artifact.');
  ...
  return 'Abrium DOM report v3 printed above. Next: run __abriumWatchCopy()';
})();
