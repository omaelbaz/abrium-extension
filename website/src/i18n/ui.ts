export const EN = {
  ...
  sidePanel: "Side panel", popup: "Toolbar popup", searchPh: "Search the Vault", screenshot: "Screenshot",
...
export const AR = {
  ...
  sidePanel: "اللوحة الجانبية", popup: "نافذة شريط الأدوات", searchPh: "ابحث في الخزنة", screenshot: "لقطة شاشة",
...
export const FR = {
  ...
  sidePanel: "Panneau latéral", popup: "Fenêtre de la barre d'outils", searchPh: "Rechercher dans le Coffre", screenshot: "Capture d'écran",
...
export const ES = {
  ...
  sidePanel: "Panel lateral", popup: "Ventana de la barra de herramientas", searchPh: "Buscar en la Bóveda", screenshot: "Captura de pantalla",
...
export const PT = {
  ...
  sidePanel: "Painel lateral", popup: "Janela da barra de ferramentas", searchPh: "Pesquisar no Cofre", screenshot: "Captura de tela",
